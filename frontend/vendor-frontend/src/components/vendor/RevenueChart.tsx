...
export default function RevenueChart({ data, timeRange }: RevenueChartProps) {
  return (
    <div className="w-full bg-white dark:bg-slate-800 p-6 rounded-2xl border border-line dark:border-slate-700 shadow-sm">
      ...
      {/* Fixed: Add explicit height container with min-height */}
