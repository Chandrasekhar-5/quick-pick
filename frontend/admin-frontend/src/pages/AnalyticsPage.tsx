import { monthlyRevenue, ordersPerShop, topItems, topVendors } from "@/lib/mockData";
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-card rounded-xl border border-border p-5">
          ...
          <ResponsiveContainer width="100%" height={280}>
            <PieChart>
              <Pie data={ordersPerShop} dataKey="orders" nameKey="shop" cx="50%" cy="50%" outerRadius={100} label={({ shop, percent }) => `${shop} ${(percent * 100).toFixed(0)}%`} labelLine={false}>
